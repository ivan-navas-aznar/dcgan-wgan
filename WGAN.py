...
jovian.reset()
jovian.log_hyperparams(lr=lr, epochs=epochs, clamp_num=clamp_num)
print('\n\n\n')
...
# ## Guardado y Commit
# Finalmente, procedemos a guardar todos los datos en Jovian:

jovian.commit(project=project_name,
              outputs=['G.pth', 'D.pth', 'wgan_training.avi'],
              environment=None)
